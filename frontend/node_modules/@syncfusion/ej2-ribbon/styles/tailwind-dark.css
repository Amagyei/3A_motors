...
.e-ribbon.e-rbn.e-ribbon-container .e-ribbon-overlay .e-ribbon-skeleton.e-skeleton.e-shimmer-wave::after {
  background-image: -webkit-gradient(linear, left top, right top, color-stop(39%, rgba(255, 255, 255, 0)), color-stop(53%, #232e3e), color-stop(67%, rgba(255, 255, 255, 0)));
  background-image: linear-gradient(90deg, rgba(255, 255, 255, 0) 39%, #232e3e 53%, rgba(255, 255, 255, 0) 67%);
}
.e-ribbon.e-rbn .e-ribbon-tab .e-tab-header {
  border-color: unset;
  background: #374151;
...
.e-dropdown-popup.e-ribbon-gallery-dropdown .e-ribbon-gallery-item:focus-visible {
  border-color: 0 0 0 2px rgba(31, 41, 55, 0.95), 0 0 0 4px #22d3ee;
}
