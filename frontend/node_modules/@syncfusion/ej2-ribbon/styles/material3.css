...
.e-ribbon.e-rbn.e-ribbon-container .e-ribbon-overlay .e-ribbon-skeleton.e-skeleton.e-shimmer-wave::after {
  background-image: -webkit-gradient(linear, left top, right top, color-stop(33%, rgba(255, 255, 255, 0)), color-stop(51%, rgba(var(--color-sf-primary-container), 0.5)), color-stop(70%, rgba(255, 255, 255, 0)));
  background-image: linear-gradient(90deg, rgba(255, 255, 255, 0) 33%, rgba(var(--color-sf-primary-container), 0.5) 51%, rgba(255, 255, 255, 0) 70%);
}
.e-ribbon.e-rbn .e-ribbon-tab .e-tab-header {
  border-color: unset;
  background: -webkit-gradient(linear, left bottom, left top, from(rgba(var(--color-sf-primary), 0.08)), to(rgba(var(--color-sf-primary), 0.08))), rgba(var(--color-sf-surface));
