...
.e-ribbon.e-rbn.e-ribbon-container .e-ribbon-overlay .e-ribbon-skeleton.e-skeleton.e-shimmer-wave::after {
  background-image: -webkit-gradient(linear, left top, right top, color-stop(15%, rgba(255, 255, 255, 0)), color-stop(28%, rgb(117, 117, 117)), color-stop(42%, rgba(255, 255, 255, 0)));
  background-image: linear-gradient(90deg, rgba(255, 255, 255, 0) 15%, rgb(117, 117, 117) 28%, rgba(255, 255, 255, 0) 42%);
}
.e-ribbon.e-rbn .e-ribbon-tab .e-tab-header {
  border-color: #757575;
  background: #212121;
...
.e-ribbon-dropdown-group-button.e-dropdown-popup {
  background: #212121;
  -webkit-box-shadow: 0 6px 6px 0 rgba(0, 0, 0, 0.23), 0 10px 20px 0 rgba(0, 0, 0, 0.19);
