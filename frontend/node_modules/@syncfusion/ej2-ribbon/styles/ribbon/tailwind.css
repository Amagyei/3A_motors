...
.e-ribbon.e-rbn.e-ribbon-container .e-ribbon-overlay .e-ribbon-skeleton.e-skeleton.e-shimmer-wave::after {
  background-image: -webkit-gradient(linear, left top, right top, color-stop(39%, rgba(255, 255, 255, 0)), color-stop(53%, #f9fafb), color-stop(67%, rgba(255, 255, 255, 0)));
  background-image: linear-gradient(90deg, rgba(255, 255, 255, 0) 39%, #f9fafb 53%, rgba(255, 255, 255, 0) 67%);
}
.e-ribbon.e-rbn .e-ribbon-tab .e-tab-header {
  border-color: unset;
  background: #f3f4f6;
...
.e-dropdown-popup.e-ribbon-gallery-dropdown .e-ribbon-gallery-item:focus-visible {
  border-color: 0 0 0 2px rgba(255, 255, 255, 0.95), 0 0 0 4px #4f46e5;
}
