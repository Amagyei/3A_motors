...
.e-dropdown-popup.e-ribbon-dropdown-group-button .e-btn-group .e-btn.e-ribbon-group-button {
  ...
  font-weight: 400;
  font-size: 12px;
  border: 1px solid var(--color-sf-bg-primary);
  text-transform: none;
}
...
.e-ribbon.e-rbn.e-ribbon-container .e-ribbon-overlay .e-ribbon-skeleton.e-skeleton.e-shimmer-wave::after {
  background-image: -webkit-gradient(linear, left top, right top, color-stop(15%, transparent), color-stop(38%, rgb(248, 249, 250)), color-stop(60%, transparent));
  background-image: linear-gradient(90deg, transparent 15%, rgb(248, 249, 250) 38%, transparent 60%);
}
.e-ribbon.e-rbn .e-ribbon-tab .e-tab-header {
  border-color: unset;
  background: var(--color-sf-bg-secondary);
...
.e-ribbon-backstage-popup .e-btn:focus {
  ...
  color: var(--color-sf-on-brand-solid-primary);
  border-color: var(--color-sf-utility-primary-lighter);
}
...
.e-ribbon-group-overflow-ddb .e-ribbon-item:not(.e-disabled) .e-split-btn-wrapper.e-ribbon-open {
  border-color: var(--color-sf-utility-secondary-bg-color-pressed);
}
...
.e-ribbon-group-overflow-ddb .e-input-group:not(.e-success):not(.e-warning):not(.e-error):not(.e-float-icon-left).e-disabled {
  border-color: var(--color-sf-fg-disabled);
}
.e-ribbon.e-rbn .e-ribbon-group::after,
...
.e-ribbon-tooltip.e-tooltip-wrap.e-popup {
  background: var(--color-sf-utility-tooltip-bg);
}
