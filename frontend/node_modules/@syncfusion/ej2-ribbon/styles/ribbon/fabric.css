...
.e-ribbon.e-rbn.e-ribbon-container .e-ribbon-overlay .e-ribbon-skeleton.e-skeleton.e-shimmer-wave::after {
  background-image: -webkit-gradient(linear, left top, right top, color-stop(15%, rgba(255, 255, 255, 0)), color-stop(38%, rgb(200, 200, 200)), color-stop(60%, rgba(255, 255, 255, 0)));
  background-image: linear-gradient(90deg, rgba(255, 255, 255, 0) 15%, rgb(200, 200, 200) 38%, rgba(255, 255, 255, 0) 60%);
}
.e-ribbon.e-rbn .e-ribbon-tab .e-tab-header {
  border-color: #dadada;
  background: #fff;
