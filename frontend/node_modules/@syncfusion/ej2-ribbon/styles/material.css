...
.e-ribbon.e-rbn.e-ribbon-container .e-ribbon-overlay .e-ribbon-skeleton.e-skeleton.e-shimmer-wave::after {
  background-image: -webkit-gradient(linear, left top, right top, color-stop(15%, rgba(255, 255, 255, 0)), color-stop(28%, rgb(189, 189, 189)), color-stop(42%, rgba(255, 255, 255, 0)));
  background-image: linear-gradient(90deg, rgba(255, 255, 255, 0) 15%, rgb(189, 189, 189) 28%, rgba(255, 255, 255, 0) 42%);
}
.e-ribbon.e-rbn .e-ribbon-tab .e-tab-header {
  border-color: #e0e0e0;
  background: #fafafa;
