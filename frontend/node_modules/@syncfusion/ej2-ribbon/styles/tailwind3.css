...
.e-ribbon.e-rbn.e-ribbon-container .e-ribbon-overlay .e-ribbon-skeleton.e-skeleton.e-shimmer-wave::after {
  background-image: -webkit-gradient(linear, left top, right top, color-stop(40%, rgba(255, 255, 255, 0)), color-stop(53%, var(--color-sf-content-bg-color-alt2)), color-stop(67%, rgba(255, 255, 255, 0)));
  background-image: linear-gradient(90deg, rgba(255, 255, 255, 0) 40%, var(--color-sf-content-bg-color-alt2) 53%, rgba(255, 255, 255, 0) 67%);
}
.e-ribbon.e-rbn .e-ribbon-tab .e-tab-header {
  border-color: unset;
  background: var(--color-sf-content-bg-color-alt1);
