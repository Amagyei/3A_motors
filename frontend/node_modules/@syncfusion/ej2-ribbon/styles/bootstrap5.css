...
.e-ribbon.e-rbn.e-ribbon-container .e-ribbon-overlay .e-ribbon-skeleton.e-skeleton.e-shimmer-wave::after {
  background-image: -webkit-gradient(linear, left top, right top, color-stop(15%, rgba(255, 255, 255, 0)), color-stop(38%, #f8f9fa), color-stop(60%, rgba(255, 255, 255, 0)));
  background-image: linear-gradient(90deg, rgba(255, 255, 255, 0) 15%, #f8f9fa 38%, rgba(255, 255, 255, 0) 60%);
}
.e-ribbon.e-rbn .e-ribbon-tab .e-tab-header {
  border-color: unset;
  background: #f8f9fa;
