...
var CommandHandler = /** @class */ (function () {
            ...
            for (var i = 0; i < objects.length; i++) {
                ...
                if (this.diagram.nodes.length !== 1 && (this.diagram.nameTable["" + objectId].children === undefined ||
                    ...
                    if (obj.zIndex > minZindex && obj.shape.type !== 'SwimLane') {
                        ...
                        if (obj.children) {
                            minZindex = this.findLowestZIndex(obj, layerObjects) || minZindex;
                        }
    ...
    CommandHandler.prototype.updateGroupZindex = function (parent, command, index) {
        if (command === 'SendToBack' || command === 'SendBackward') {
            var parentZindex = parent.zIndex;
        ...
        if (hasSelection(this.diagram) || obj) {
            ...
            for (var i = 0; i < objects.length; i++) {
                ...
                if (obj_3.zIndex < maxZindex && obj_3.shape.type !== 'SwimLane') {
                    ...
                    var parentZindex = 0;
                    if (obj_3.children) {
                        maxZindex = this.findGreatestZIndex(obj_3, layerObjects) || maxZindex;
                        this.updateGroupZindex(obj_3, 'BringToFront', maxZindex);
                        for (var i_7 = 0; i_7 < obj_3.children.length; i_7++) {
                            var child = this.diagram.nameTable[obj_3.children[parseInt(i_7.toString(), 10)]];
                    ...
                    obj_3.zIndex = parentZindex + ((objects.indexOf(obj_3) !== -1 ? objects.indexOf(obj_3) : 0) + 1);
                ...
                // }
                    ...
                    for (var i_8 = 0; i_8 <= index; i_8++) {
                        if (zIndexTable[parseInt(i_8.toString(), 10)]
                            && this.diagram.nameTable[zIndexTable[parseInt(i_8.toString(), 10)]].parentId === objectName) {
                            if (childIndex === -1) {
                                childIndex = i_8;
                                tempIndex_1 = i_8;
                                break;
                    ...
                    for (var i_9 = 0; i_9 <= tabelLength; i_9++) {
                        if (tempTable[parseInt(i_9.toString(), 10)] && tempTable[parseInt(i_9.toString(), 10)] !== objectName
                            && this.diagram.nameTable[tempTable[parseInt(i_9.toString(), 10)]].parentId !== objectName) {
                            var node = this.diagram.nameTable[tempTable[parseInt(i_9.toString(), 10)]];
                    ...
                    var k = childIndex;
                    for (var i_10 = 0; i_10 <= childCount; i_10++) {
                        while (!zIndexTable[parseInt(k.toString(), 10)]) {
                            k++;
                        }
                    ...
                    for (var i_11 = laneIndex; i_11 <= tabelLength; i_11++) {
                        while (!cloneTable[parseInt(childIndex.toString(), 10)]) {
                            childIndex++;
                        }
                        while (!zIndexTable[parseInt(i_11.toString(), 10)]) {
                            i_11++;
                        }
                        zIndexTable[parseInt(i_11.toString(), 10)] = cloneTable[parseInt(childIndex.toString(), 10)];
                        this.diagram.nameTable[zIndexTable[parseInt(i_11.toString(), 10)]].zIndex = i_11;
                        childIndex++;
                    }
                    zIndexTable[parseInt(tabelLength.toString(), 10)] = this.diagram.nameTable["" + objectName].id;
                    this.diagram.nameTable["" + objectName].zIndex = tabelLength;
                    k = index + 1;
                    var j = tempIndex_1;
                    for (var i_12 = 0; i_12 < childCount; i_12++) {
                        while (!tempTable[parseInt(k.toString(), 10)]) {
                            k++;
                        }
                ...
                if (this.diagram.mode === 'SVG') {
                    ...
                    var i_13 = obj_4.shape.type !== 'SwimLane' ? maxZindex : tempIndex;
                    // if (i !== tempIndex) {
                    //     i = (obj.children && obj.children.length > 0) ? index : 1;
                    // }
                    var target = zIndexTable[parseInt(i_13.toString(), 10)];
                    // EJ2-49326 - (CR issue fix) An exception raised when send the swimlane back to the normal node.
                    // while (!target && i > index) {
                    //     target = zIndexTable[++i];
                    // }
                    // EJ2-46656 - CR issue fix
                    target = this.resetTargetNode(objectName, target, i_13, zIndexTable);
                    //EJ2-69654 - Send to back command not working when there is single node in layer
                    if (target) {
                        target = this.diagram.nameTable["" + target].parentId ? this.checkParentExist(target) : target;
    ...
    CommandHandler.prototype.findGreatestZIndex = function (parent, layerObjects) {
        var layerObj = this.diagram.nodes.filter(function (node) { return layerObjects.indexOf(node.id) !== -1; });
        // Get zIndex values of nodes excluding children of the parent
        var zIndexes = layerObj.filter(function (node) { return node.parentId === '' && node.id !== parent.id; }).map(function (node) { return node.zIndex; });
        // Sort zIndexes in descending order
        zIndexes.sort(function (a, b) { return b - a; });
    ...
    CommandHandler.prototype.findLowestZIndex = function (parent, layerObjects) {
        var layerObj = this.diagram.nodes.filter(function (node) { return layerObjects.indexOf(node.id) !== -1; });
        // Get zIndex values of nodes excluding children of the parent
        var zIndexes = layerObj.filter(function (node) { return node.parentId === '' && node.id !== parent.id; }).map(function (node) { return node.zIndex; });
    ...
    CommandHandler.prototype.swapDomOrder = function (nextNodeId, targetId) {
        if (nextNodeId) {
            //Bug 921994: Z-index order changes are not reflected at the UI level with Undo Redo commands.
            var node = this.diagram.getObject(targetId);
            if (node.shape.type === 'Native' || node.shape.type === 'HTML') {
    ...
    CommandHandler.prototype.sendForward = function (obj) {
        ...
        if (hasSelection(this.diagram) || obj) {
            ...
            var _loop_2 = function (s) {
                ...
                var layerIndex = this_2.diagram.layers.indexOf(this_2.getObjectLayer(nodeId));
                var originalNameTable = cloneObject(this_2.diagram.nameTable);
                var zIndexTable = this_2.diagram.layers[parseInt(layerIndex.toString(), 10)].zIndexTable;
                //const tabelLength: number = Object.keys(zIndexTable).length;
                var index = this_2.diagram.nameTable["" + nodeId];
                var intersectArray = [];
                var temp = this_2.diagram.spatialSearch.findObjects(index.wrapper.bounds);
                if (temp.length > 2) {
                    temp = this_2.sortByZIndex(temp, undefined, 'BringForward');
                }
                for (var _i = 0, temp_1 = temp; _i < temp_1.length; _i++) {
                    var i = temp_1[_i];
                    if (index.id !== i.id) {
                        var currentLayer = this_2.getObjectLayer(i.id).zIndex;
                        if (layerIndex === currentLayer && (Number(this_2.diagram.nameTable["" + nodeId].zIndex) < Number(i.zIndex)) && i.parentId === '' &&
                ...
                for (var i = intersectArray.length - 1; i >= 0; i--) {
                    var child = this_2.diagram.nameTable[intersectArray[parseInt(i.toString(), 10)].id];
                    if (child.parentId === nodeId) {
                        intersectArray.splice(i, 1);
                    }
                }
                if (intersectArray.length > 0) {
                    var node = this_2.diagram.nameTable[intersectArray[intersectArray.length - 1].id];
                    if (node.parentId) {
                        var parentId = '';
                        var parent_1 = findParentInSwimlane(node, this_2.diagram, parentId);
                        var obj_5 = this_2.diagram.nameTable["" + parent_1];
                        if (obj_5.id !== nodeId) {
                    ...
                    for (var i = 0; i < this_2.diagram.nodes.length; i++) {
                        var node1 = this_2.diagram.nodes[parseInt(i.toString(), 10)];
                        originalZIndexTable[node1.id] = node1.zIndex;
                    }
                    // Store original zIndex values for connectors
                    for (var j = 0; j < this_2.diagram.connectors.length; j++) {
                        var connector = this_2.diagram.connectors[parseInt(j.toString(), 10)];
                        originalZIndexTable[connector.id] = connector.zIndex;
                    }
                    var overlapObject = intersectArray[0].zIndex;
                    var temp_2 = zIndexTable[parseInt(overlapObject.toString(), 10)];
                    var undoObject_2 = cloneObject(this_2.diagram.selectedItems);
                    this_2.diagram.startGroupAction();
                    ...
                    if (index) {
                        ...
                        if (Object.keys(zIndex_1).length > 0) {
                            ...
                            if (greaterItems_1.length !== 0) {
                                this_2.updateZIndexBySendForward(index, greaterItems_1, layerIndex);
                            }
                        }
                    }
                    var changedNodeZIndexesArray_1 = [];
                    Object.keys(this_2.changedNodeZIndexes).forEach(function (nodeId) {
                    ...
                    this_2.updateLayerZindexTable(layerIndex);
                    ...
                    if (this_2.diagram.mode === 'SVG') {
                        ...
                        this_2.moveAfterSvgNode(nodeId, nodeIdToUpdate);
                        // }
                        this_2.updateNativeNodeIndex(nodeIdToUpdate, nodeId);
                    }
                    else {
                        this_2.diagram.refreshCanvasLayers();
                    }
                    ...
                    var redoObject_1 = cloneObject(this_2.diagram.selectedItems);
                    ...
                    if (!(this_2.diagram.diagramActions & DiagramAction.UndoRedo)) {
                        this_2.addHistoryEntry(historyEntry);
                    }
                    this_2.diagram.endGroupAction();
                }
            };
            var this_2 = this;
    ...
    CommandHandler.prototype.updateZIndexBySendForward = function (selectedNode, greaterItems, layerNum) {
        ...
        var highChildIndex = Math.min.apply(Math, greaterItems);
        var index = Math.min.apply(Math, greaterItems);
        var highIndex;
        var layerObjects = this.diagram.layers[parseInt(layerNum.toString(), 10)].objects;
        var objects = this.diagram.nodes.filter(function (node) { return layerObjects.indexOf(node.id) !== -1; });
        if (selectedNode.children) {
            this.updateGroupZindex(selectedNode, 'BringForward', selectedNode.zIndex);
        }
        var frontNode = objects.filter(function (x) { return x.zIndex === Math.min.apply(Math, greaterItems) && x.id !== selectedNode.id; });
        if (frontNode && frontNode.length > 0 && frontNode[0].children) {
            var frontNodeIndex = Math.min.apply(Math, greaterItems);
            ...
            this.arrangeZIndexForLowerNodes(highChildIndex, frontNode[0], objects);
        }
        if (selectedNode.children) {
        ...
        for (var i = 0; i < sortedObjects.length; i++) {
            ...
            if (node.zIndex > index && node !== selectedNode && node.parentId !== selectedNode.id &&
                frontNode && frontNode.length > 0 && node.parentId !== frontNode[0].id) {
    ...
    CommandHandler.prototype.arrangeZIndexForLowerNodes = function (index, parent, objects) {
        var lesserIndexNodes = objects.filter(function (x) { return x.zIndex <= index && x.parentId !== parent.id; });
        lesserIndexNodes.sort(function (a, b) { return b.zIndex - a.zIndex; });
        for (var i = 0; i < lesserIndexNodes.length; i++) {
    ...
    CommandHandler.prototype.sendBackward = function (obj) {
        ...
        if (hasSelection(this.diagram) || obj) {
            ...
            var _loop_3 = function (s) {
                ...
                var layerNum = this_3.diagram.layers.indexOf(this_3.getObjectLayer(objectId));
                var originalNameTable = cloneObject(this_3.diagram.nameTable);
                var zIndexTable = this_3.diagram.layers[parseInt(layerNum.toString(), 10)].zIndexTable;
                //const tabelLength: number = Object.keys(zIndexTable).length;
                var node = this_3.diagram.nameTable["" + objectId];
                var intersectArray = [];
                var temp = this_3.diagram.spatialSearch.findObjects(node.wrapper.bounds);
                if (temp.length > 2) {
                    temp = this_3.sortByZIndex(temp);
                }
                for (var _i = 0, temp_3 = temp; _i < temp_3.length; _i++) {
                    var i = temp_3[_i];
                    if (node.id !== i.id) {
                        var currentLayer = this_3.getObjectLayer(i.id).zIndex;
                        if (layerNum === currentLayer && (Number(this_3.diagram.nameTable["" + objectId].zIndex) > Number(i.zIndex)) && i.parentId === '' &&
                ...
                for (var i = intersectArray.length - 1; i >= 0; i--) {
                    var child = this_3.diagram.nameTable[intersectArray[parseInt(i.toString(), 10)].id];
                    if (child.parentId === objectId) {
                        intersectArray.splice(i, 1);
                    }
                }
                if (intersectArray.length > 0) {
                    var child = this_3.diagram.nameTable[intersectArray[intersectArray.length - 1].id];
                    if (child.parentId) {
                        var parentId = '';
                        var parent_2 = findParentInSwimlane(child, this_3.diagram, parentId);
                        var obj_6 = this_3.diagram.nameTable["" + parent_2];
                    ...
                    var originalZIndexTable = {}; // New variable to store original zIndex values
                    // Store original zIndex values for nodes
                    for (var i = 0; i < this_3.diagram.nodes.length; i++) {
                        var node1 = this_3.diagram.nodes[parseInt(i.toString(), 10)];
                        originalZIndexTable[node1.id] = node1.zIndex;
                    }
                    // Store original zIndex values for connectors
                    for (var j = 0; j < this_3.diagram.connectors.length; j++) {
                        var connector = this_3.diagram.connectors[parseInt(j.toString(), 10)];
                        originalZIndexTable[connector.id] = connector.zIndex;
                    }
                    var overlapObject = intersectArray[intersectArray.length - 1].zIndex;
                    var temp_4 = zIndexTable[parseInt(overlapObject.toString(), 10)];
                    var undoObject_3 = cloneObject(this_3.diagram.selectedItems);
                    this_3.diagram.startGroupAction();
                    var zIndex_2 = {};
                    intersectArray.forEach(function (item) {
                    ...
                    if (node) {
                        ...
                        if (Object.keys(zIndex_2).length > 0) {
                            ...
                            if (lesserItems_1.length !== 0) {
                                this_3.updateZIndexBySendBackward(node, lesserItems_1, layerNum);
                            }
                        }
                    }
                    var changedNodeZIndexesArray_2 = [];
                    Object.keys(this_3.changedNodeZIndexes).forEach(function (nodeId) {
                        var originalZIndex = originalNameTable["" + nodeId] ? originalNameTable["" + nodeId].zIndex : null;
                        var changedZIndex = _this.changedNodeZIndexes["" + nodeId];
                        //By comparing with changedNodeZIndexes to store the changed elements in undo
                        if (originalZIndex !== changedZIndex) {
                    ...
                    this_3.updateLayerZindexTable(layerNum);
                    ...
                    if (this_3.diagram.mode === 'SVG') {
                        var nodeIdToUpdate = intersectArray[intersectArray.length - 1].id;
                        var element = intersectArray[intersectArray.length - 1];
                        if (element && !(element.shape.type === 'HTML'
                            || element.shape.type === 'Native')) {
                            // this.moveBackSvgNode(objectId);
                            this_3.moveSvgNode(objectId, nodeIdToUpdate);
                        }
                        var node_5 = this_3.diagram.nameTable["" + nodeIdToUpdate];
                        if (node_5.children && node_5.children.length > 0) {
                            this_3.updateNativeNodeIndex(objectId);
                        }
                        else {
                            this_3.updateNativeNodeIndex(objectId, nodeIdToUpdate);
                        }
                    }
                    else {
                        this_3.diagram.refreshCanvasLayers();
                    }
                    ...
                    var redoObject_2 = cloneObject(this_3.diagram.selectedItems);
                    ...
                    if (!(this_3.diagram.diagramActions & DiagramAction.UndoRedo)) {
                        this_3.addHistoryEntry(entry);
                    }
                    this_3.diagram.endGroupAction();
                }
            };
            var this_3 = this;
            for (var s = objects.length - 1; s >= 0; s--) {
    ...
    CommandHandler.prototype.updateZIndexBySendBackward = function (selectedNode, lesserItems, layerNum) {
        ...
        var index = selectedNode.zIndex;
        var lowChildIndex = Math.max.apply(Math, lesserItems);
        var layerObjects = this.diagram.layers[parseInt(layerNum.toString(), 10)].objects;
        var objects = this.diagram.nodes.filter(function (node) { return layerObjects.indexOf(node.id) !== -1; });
        var backNode = objects.filter(function (x) { return x.zIndex === Math.max.apply(Math, lesserItems) && x.id !== selectedNode.id; });
        if (backNode && backNode.length > 0 && backNode[0].children) {
            // eslint-disable-next-line prefer-spread
            var backNodeIndex = Math.max.apply(Math, lesserItems);
            for (var i = 0; i < backNode[0].children.length; i++) {
                var backNodeChild = this.diagram.nameTable[backNode[0].children[parseInt(i.toString(), 10)]];
        ...
        for (var i = 0; i < sortedObjects.length; i++) {
            var node = sortedObjects[parseInt(i.toString(), 10)];
            if (node.zIndex < index && node !== selectedNode && node.parentId !== selectedNode.id &&
                backNode && backNode.length > 0 && node.parentId !== backNode[0].id) {
