...
var DiagramRenderer = /** @class */ (function () {
        ...
        if (group.hasChildren()) {
            ...
            if (!(group.elementActions & ElementAction.ElementIsGroup) && diagram instanceof Diagram && diagram.nameTable[group.id] && diagram.nameTable[group.id].propName !== 'connectors') {
                if (isNodeSelected && selectedNode) {
                    ...
                    else if (group.children[0] instanceof DiagramNativeElement && (selectedNode.flipMode === 'All' || selectedNode.flipMode === 'Label') || (selectedNode.flipMode === 'Label' || selectedNode.flipMode === 'PortAndLabel' || selectedNode.flipMode === 'LabelText' || selectedNode.flipMode === 'PortAndLabelText' || selectedNode.flipMode === 'LabelAndLabelText') || (selectedNode.shape.type === 'Image' && selectedNode.flipMode === 'Label')) {
                    ...
                    //Below code to check and flip the text element in the node.
                        ...
                        for (var i = 0; i < selectedNode.wrapper.children.length; i++) {
                            if (selectedNode.wrapper.children[parseInt(i.toString(), 10)] instanceof TextElement) {
                                ...
                                this.renderFlipTextElement(group, innerLabelContent, selectedNode.wrapper.children[parseInt(i.toString(), 10)], group.flip, selectedNode.flipMode);
                                return;
                            }
                        }
                    }
     ...
     */
    DiagramRenderer.prototype.renderFlipTextElement = function (element, canvas, textElement, flip, flipMode) {
        var attr = {};
        var scaleX = 1;
        var scaleY = 1;
        var posX = 0;
            ...
            if (textPos) {
                ...
                if (flipMode === 'All' || flipMode === 'LabelAndLabelText') {
                    ...
                    if (flip === 'Horizontal' || flip === 'Vertical') {
                        var angle = Math.sin(element.rotateAngle * Math.PI / 180);
    ...
    DiagramRenderer.prototype.setFlipAttributes = function (element, canvas, attr, scaleX, scaleY) {
        if (attr) {
