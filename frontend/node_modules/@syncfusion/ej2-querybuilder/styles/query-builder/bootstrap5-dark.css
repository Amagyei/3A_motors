...
.e-query-builder .e-group-header .e-drag-qb-rule {
  margin: 1px;
  padding: 10px 10px 10px 2px !important; /* stylelint-disable-line declaration-no-important */
}
.e-query-builder .e-drag-rule-bottom-line {
  border-bottom: 2px solid #0d6efd !important; /* stylelint-disable-line declaration-no-important */
}
.e-query-builder .e-drag-rule-top-line {
  border-top: 2px solid #0d6efd !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-query-builder .e-group-header .e-dropdown-btn.e-add-btn,
.e-query-builder .e-deletegroup, .e-query-builder .e-group-header .e-clone-grp-btn, .e-query-builder .e-group-header .e-lock-grp-btn {
  background: #212529;
  -webkit-box-shadow: none;
          box-shadow: none;
  color: #adb5bd;
