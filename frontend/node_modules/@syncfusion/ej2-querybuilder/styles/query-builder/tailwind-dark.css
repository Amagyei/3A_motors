...
.e-query-builder .e-drag-rule-bottom-line {
  border-bottom: 2px solid #22d3ee !important; /* stylelint-disable-line declaration-no-important */
}
.e-query-builder .e-drag-rule-top-line {
  border-top: 2px solid #22d3ee !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-bigger .e-query-builder .e-group-header .e-drag-qb-rule {
  padding: 10px 10px 10px 6px !important; /* stylelint-disable-line declaration-no-important */
}