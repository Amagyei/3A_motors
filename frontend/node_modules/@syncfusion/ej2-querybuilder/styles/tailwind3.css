...
.e-query-builder .e-drag-rule-bottom-line {
  border-bottom: 2px solid var(--color-sf-primary) !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-query-builder .e-collapse-rule:focus, .e-query-builder .e-collapse-rule:hover {
