...
import { getSwapRange, getRangeIndexes, setAutoFill, getFillInfo, getSheetIndexFromAddress, workbookLocale, workbookReadonlyAlert } from './../common/index';
            ...
            while (j < clen) {
                ...
                if (val !== '0' || (val === '0' && options.fillType !== 'FillWithoutFormatting')) {
                    cellProps.value = isFormula && this.parent.calculationMode === 'Manual' && options.fillType === 'FillWithoutFormatting'
                        ? !isNullOrUndefined(data[l]) ? data[l].value : '0' : val;
                }
