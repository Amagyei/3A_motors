import { getRangeIndexes, updateCell, applyCellFormat, isReadOnly, isImported, getSwapRange } from '../common/index';
...
import { localizedFormatAction } from '../common/index';
/**
...
var WorkbookNumberFormat = /** @class */ (function () {
    ...
    WorkbookNumberFormat.prototype.accountingFormat = function (args, fResult, intl, cell) {
        ...
        var formatArr = args.format.split(';');
        var numArgs = checkIsNumberAndGetNumber({ value: fResult }, this.parent.locale, this.localeObj.group, this.localeObj.decimal);
        if (numArgs.isNumber) {
            cell.value = args.value = numArgs.value;
            var cellVal = Number(args.value);
            if (cellVal >= 0) {
    ...
    WorkbookNumberFormat.prototype.shortDateFormat = function (args, intl, cell) {
        ...
        if (!isNumber(args.value) && args.value && cell) {
            ...
            var dateArgs = { value: args.value, updatedVal: args.value, cell: cell, isEdit: args.isEdit, intl: intl,
