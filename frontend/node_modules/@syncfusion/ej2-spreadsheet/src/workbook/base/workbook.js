...
var Workbook = /** @class */ (function (_super) {
    ...
    Workbook.prototype.isValidCell = function (cellAddress) {
        var sheet = this.getActiveSheet();
        var range = getCellIndexes(cellAddress ? cellAddress : sheet.activeCell);
     ...
     * @hidden
     */
    Workbook.prototype.updateCellDetails = function (cell, address, cellInformation, isRedo, isDependentUpdate) {
        var range;
        var sheetIdx;
        if (!address) {
