...
var SpreadsheetChart = /** @class */ (function () {
    ...
    SpreadsheetChart.prototype.processChartRange = function (range, dataSheetIdx, opt) {
        ...
        var trVal = getPropertyValue(minr, maxc, false, true);
        var blVal = getPropertyValue(maxr, minc, true);
        var tlVal = getPropertyValue(minr, minc, true);
    ...
    SpreadsheetChart.prototype.changeCharType = function (chartCollId) {
        ...
        chartParEle.remove();
        this.initiateChartHandler({ option: this.parent.chartColl[chartCollId], isInitCell: false, triggerEvent: false, isPaste: false });
