...
import { hasTemplate, editAlert, getTextWidth, readonlyAlert } from '../common/index';
...
var Edit = /** @class */ (function () {
    ...
    Edit.prototype.positionEditor = function (isWrap) {
        ...
        if (tdElem) {
            ...
            editorElem.setAttribute('style', inlineStyles_1);
    ...
    Edit.prototype.updateCell = function (oldCellValue, tdRefresh, value, newVal, e) {
        ...
        var isCellValChanged = oldCellValue !== curCellValue || (this.parent.calculationMode === 'Manual' &&
    ...
    Edit.prototype.getRefreshNodeArgs = function (cell, tdEle, rowIdx, colIdx) {
        cell = cell || {};
        var eventArgs = { value: cell.value, format: cell.format, formattedText: cell.value, isRightAlign: false,
    ...
    Edit.prototype.readOnlyAlertHandler = function () {
        ...
        dialog.show({
            ...
            beforeOpen: function (args) {
                ...
                if (dlgArgs.cancel) {
                    args.cancel = true;
                    getUpdateUsingRaf(function () { return dialog.destroyDialog(); });
                }
