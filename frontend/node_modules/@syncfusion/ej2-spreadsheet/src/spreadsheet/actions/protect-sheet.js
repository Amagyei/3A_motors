...
import { EventHandler, closest, getComponent, isNullOrUndefined, getInstance } from '@syncfusion/ej2-base';
...
var ProtectSheet = /** @class */ (function () {
    ...
    ProtectSheet.prototype.checkBoxClickHandler = function () {
        var ch = getInstance(document.getElementById(this.parent.element.id + '_protect_check'), CheckBox);
