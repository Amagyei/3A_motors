...
import { isDateTime, dateToInt, applyCellFormat, clearCF, getSwapRange } from '../../workbook/common/index';
...
var ConditionalFormatting = /** @class */ (function () {
    ...
    ConditionalFormatting.prototype.updateCF = function (args, sheet, cf, updatedCFCellRef) {
        ...
        var updateCF = function (rIdx, cIdx, cell, td, currentRowHeight) {
            ...
            switch (cf.type) {
                ...
                case 'LessThan':
                    ...
                    break;
                case 'Between':
                    isApply = isNumber(cellVal) && cellType !== 'Text' && _this.isBetWeen(cf, cellVal, value1, value2);
                    break;
                case 'EqualTo':
                    isApply = isNumber(cellVal) && cellType !== 'Text' && _this.isEqualTo(cf, cellVal, value1);
                    break;
                case 'ContainsText':
