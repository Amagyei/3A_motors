...
var CellFormat = /** @class */ (function () {
        ...
        if (cell) {
            ...
            if (args.style.border !== undefined || args.style.borderTop !== undefined || args.style.borderLeft !== undefined) {
                ...
                if (cell && cell.querySelector('.e-cf-databar') && args.style.verticalAlign) {
                    cell.querySelector('.e-databar-value').style.alignItems =
    ...
    CellFormat.prototype.clearObj = function (args) {
        ...
        if (isOverlay) {
            ...
            this.parent.serviceLocator.getService('cell').refreshRange(getSwapRange(getRangeIndexes(range)), false, false, false, false, isImported(this.parent), !isClearAll);
