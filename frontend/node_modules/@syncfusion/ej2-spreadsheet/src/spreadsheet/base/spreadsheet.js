...
import { mouseDown, spreadsheetDestroyed, keyUp, clearViewer, refreshSheetTabs, positionAutoFillElement, updateSortCollection, isReadOnlyCells, readonlyAlert, deInitProperties } from '../common/index';
...
import { getCellAddress, getColumnHeaderText, getSwapRange, getSheetIndexFromAddress } from './../../workbook/common/index';
...
var Spreadsheet = /** @class */ (function (_super) {
     ...
     * @hidden
     */
    Spreadsheet.prototype.updateCellInfo = function (cell, address, isDependentUpdate, cellInformation, isRedo) {
        address = address || this.getActiveSheet().activeCell;
        if (isReadOnlyCells(this, getRangeIndexes(address))) {
            return;
        }
        _super.prototype.updateCellDetails.call(this, cell, address, cellInformation, isRedo, isDependentUpdate);
    };
    /**
    ...
    Spreadsheet.prototype.isColumnRange = function (range) {
        var isValid = true;
        // Iterate over each character in the range string
        Array.from(range).forEach(function (char) {
    ...
    Spreadsheet.prototype.isRowRange = function (range) {
        var isValid = true;
        // Iterate over each character in the range string
        Array.from(range).forEach(function (char) {
