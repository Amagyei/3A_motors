...
.e-pv-diagram-border,
.e-pv-diagram-resize-handle {
  stroke: var(--color-sf-primary) !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-pv-search-bar {
  ...
  border: 1px solid var(--color-sf-border-light);
  border-radius: 2px;
  -webkit-box-shadow: 0 3px 8px 0 var(--color-sf-border-light);
...
.e-pv-annotation-thickness-popup-container {
  background-color: var(--color-sf-content-bg-color-alt1);
  -webkit-box-shadow: 0 3px 8px 0 var(--color-sf-content-bg-color-hover);
...
.e-pv-properties-line-leader-length-container {
  margin-top: 10px;
  width: 45% !important; /* stylelint-disable-line declaration-no-important */
  margin-left: 7% !important; /* stylelint-disable-line declaration-no-important */
}

.e-pv-properties-line-stroke-color-container {
  margin-left: 8% !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-pdfviewer .e-accordion .e-acrdn-item .e-acrdn-panel .e-acrdn-content {
  -webkit-box-shadow: 0 0 0 24px var(--color-sf-content-bg-color-alt1) inset;
...
.e-dialog.e-pv-signature-dialog-blazor-height {
  max-height: 537px !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-bigger .e-pv-mobile-view .e-pv-organize-toolbar.e-toolbar .e-toolbar-item:not(.e-separator):not(.e-spacer) {
  min-width: 40px !important; /* stylelint-disable-line declaration-no-important */
...
.e-bigger .e-pv-formfield-strokethickness-icon {
  padding: 0 !important; /* stylelint-disable-line declaration-no-important */
  padding-top: 2px !important; /* stylelint-disable-line declaration-no-important */
}
