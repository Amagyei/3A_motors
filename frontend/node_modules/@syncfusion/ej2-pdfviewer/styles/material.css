...
.e-pv-shapes-toolbar {
  -webkit-box-shadow: rgba(0, 0, 0, 0.24) 0 8px 10px 0;
...
.e-pdfviewer .e-accordion .e-acrdn-item .e-acrdn-panel .e-acrdn-content {
  -webkit-box-shadow: 0 0 0 8px #fafafa inset;
...
.e-pv-signature-dialog-height .e-pv-createbtn:disabled {
  color: rgba(0, 0, 0, 0.26) !important; /* stylelint-disable-line declaration-no-important */
}
