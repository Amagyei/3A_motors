...
.e-pdfviewer .e-pv-annotation-note-author {
  border-bottom: 1px solid var(--color-sf-base-black);
  font-weight: bold;
}
...
.e-pv-sidebar-content::-webkit-scrollbar-track {
  -webkit-box-shadow: inset 0 0 0 var(--color-sf-border-secondary);
  background: var(--color-sf-bg-primary-alt);
  border: 1px solid var(--color-sf-border-secondary);
}
...
.e-pv-sidebar-content::-webkit-scrollbar-thumb {
  -webkit-box-shadow: inset 0 0 0 var(--color-sf-border-secondary);
  background: var(--color-sf-border-primary);
  background-clip: content-box;
  border: 4px solid var(--color-sf-base-transparent);
  border-radius: 100px;
}
...
.e-pv-organize-outer-border.e-pv-selected {
  border: 1px dashed var(--color-sf-border-secondary);
  position: absolute;
}
...
.e-pv-organize-anchor-node {
  ...
  width: 140px;
  height: 140px;
  border: 2px solid var(--color-sf-bg-primary);
}
...
.e-pv-organize-anchor-node.e-pv-organize-tile-draggedEle {
  border: 2px dashed var(--color-sf-border-secondary);
  background: var(--color-sf-bg-primary-alt);
}
...
.e-pv-mobile-annotation-toolbar .e-tbar-btn:focus {
  background: var(--color-sf-bg-primary-alt);
  border-color: var(--color-sf-bg-primary-alt);
}
...
.e-pdfviewer .e-pv-print-popup-container .e-spinner-pane.e-spin-center.e-spin-show {
  background-color: rgba(var(--color-sf-base-black), 0.3);
}
...
.e-pv-search-bar {
  ...
  border: 1px solid var(--color-sf-border-secondary);
  border-radius: 2px;
  -webkit-box-shadow: 0 3px 8px 0 var(--color-sf-border-secondary);
          box-shadow: 0 3px 8px 0 var(--color-sf-border-secondary);
  height: 104px;
  padding: 16px;
  position: absolute;
  width: 348px;
...
.e-pv-sidebar-toolbar .e-pv-tbar-btn:hover:not(:disabled) {
  ...
  border: var(--color-sf-bg-tertiary);
}
...
.e-pv-text-search-input.e-input-group:not(.e-disabled) .e-input-search-group-icon.e-input-group-icon:active {
  background: var(--color-sf-base-transparent);
  color: rgba(var(--color-sf-brand-primary), 0.54);
}
...
.e-pv-bookmark-container .e-listview:not(.e-list-template) .e-list-item {
  border-bottom: 1px solid var(--color-sf-brand-primary);
  height: 48px;
}
...
.e-pv-annotation-thickness-popup-container {
  background-color: var(--color-sf-base-white);
  -webkit-box-shadow: 0 3px 8px 0 var(--color-sf-bg-secondary-hover);
          box-shadow: 0 3px 8px 0 var(--color-sf-bg-secondary-hover);
  color: var(--color-sf-text-primary);
  height: auto;
  min-height: 48px;
  padding: 16px;
...
.e-pv-comments-div.e-focused {
  border: 0 0 0 1px rgba(var(--color-sf-brand-primary), 1);
  background: var(--color-sf-bg-tertiary);
}
...
.e-pdfviewer .e-accordion .e-acrdn-item .e-acrdn-panel .e-acrdn-content {
  -webkit-box-shadow: 0 0 0 8px var(--color-sf-bg-primary-alt) inset;
          box-shadow: 0 0 0 8px var(--color-sf-bg-primary-alt) inset;
  padding: 8px;
}
...
.e-pdfviewer .e-input-group.e-control-wrapper.e-editable-elements.e-input-focus {
  caret-color: var(--color-sf-base-black);
}
...
.e-pv-align-border {
  border: 1px dotted var(--color-sf-bg-secondary);
  border-radius: 5px;
  cursor: pointer;
  display: inline-block;
  width: 170px;
...
.e-pdfviewer-signatureformfields-signature.e-pv-signature-focus {
  outline: var(--color-sf-base-black) dotted 2px;
}
...
.e-pv-checkbox-div {
  border: 1px solid var(--color-sf-base-black);
  display: inline;
  height: 100%;
  left: 0;
  position: absolute;
...
.e-pv-cb-checked {
  border: solid var(--color-sf-base-black);
...
.e-pv-radio-btn:checked + .e-pv-radiobtn-span::before {
  background: var(--color-sf-base-black);
  border-radius: 50%;
}
