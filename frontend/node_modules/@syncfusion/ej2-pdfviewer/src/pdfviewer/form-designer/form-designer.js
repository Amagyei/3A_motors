        ...
        if (data) {
            ...
            if (formFieldsData.length !== this.pdfViewer.formFieldCollections.length) {
                ...
                for (var k = 0; k < formFieldNotContains.length; k++) {
                    var items = this.loadedFormFieldValue(formFieldNotContains[parseInt(k.toString(), 10)]);
            ...
            var _loop_3 = function (i) {
                ...
                if (!isNullOrUndefined(currentData)) {
                    if ((currentData.formFieldAnnotationType === 'SignatureField' || currentData.formFieldAnnotationType === 'InitialField') && (isNullOrUndefined(currentData.signatureBound))) {
                        var filteredField = this_3.pdfViewer.formFieldCollections.filter(function (field) {
                        ...
                        if (currentData.signatureType === 'Image') {
                            ...
                            if (this_3.pdfViewer.signatureFitMode === 'Default') {
                                var padding = Math.min(boundsObjects.height / this_3.pdfViewer.formFieldsModule.paddingDifferenceValue, boundsObjects.width / this_3.pdfViewer.formFieldsModule.paddingDifferenceValue);
                            ...
                            if (this_3.pdfViewer.signatureFitMode === 'Default') {
                                ...
                                boundsObjects = this_3.pdfViewer.formFieldsModule.
                            ...
                            var zoomvalue = this_3.pdfViewerBase.getZoomFactor();
                            var bounds = this_3.pdfViewer.formFieldsModule.
                            ...
                            if (this_3.pdfViewer.signatureFitMode === 'Default') {
                                bounds = this_3.pdfViewer.formFieldsModule.getDefaultBoundsforSign(bounds);
                            }
                            currentData.signatureBound = bounds;
                            currentData.signatureType = 'Text';
                            var fontSize = bounds.height / this_3.pdfViewer.formFieldsModule.signatureFontSizeConstent;
                            var textWidth = this_3.pdfViewer.formFieldsModule.
                                getTextWidth(currentData.value, fontSize, currentData.fontFamily);
                            var widthRatio = 1;
                            if (textWidth > bounds.width) {
                                widthRatio = bounds.width / textWidth;
                            }
                            currentData.fontSize = this_3.pdfViewer.formFieldsModule.getFontSize(Math.floor((fontSize * widthRatio)));
                        }
                    }
                }
                ...
                if (currentData.isRequired) {
                    if (currentData.formFieldAnnotationType === 'Textbox' || currentData.formFieldAnnotationType === 'PasswordField' || currentData.Multiline) {
                        if (currentData.value === null || currentData.value === '') {
                            ...
                            this_3.pdfViewerBase.nonFillableFields[currentData.name] = currentData.value;
                        }
                        else {
                            delete (this_3.pdfViewerBase.nonFillableFields[currentData.name]);
                        }
                    }
                        ...
                        if (currentData.radiobuttonItem) {
                            ...
                            if (!isSelected) {
                                this_3.pdfViewerBase.validateForm = true;
                                this_3.pdfViewerBase.nonFillableFields[currentData.name] = isSelected;
                            }
                            else {
                                delete (this_3.pdfViewerBase.nonFillableFields[currentData.name]);
                            }
                        ...
                        if (currentData.isChecked === false) {
                            this_3.pdfViewerBase.validateForm = true;
                            this_3.pdfViewerBase.nonFillableFields[currentData.name] = currentData.isChecked;
                        }
                        else {
                            delete (this_3.pdfViewerBase.nonFillableFields[currentData.name]);
                        }
                        ...
                        if (isNullOrUndefined(currentData.selectedIndex) || currentData.selectedIndex.length === 0) {
                            this_3.pdfViewerBase.validateForm = true;
                            this_3.pdfViewerBase.nonFillableFields[currentData.name] = currentData.selectedIndex;
                        }
                        else {
                            delete (this_3.pdfViewerBase.nonFillableFields[currentData.name]);
                        }
                ...
                if (currentData) {
                    if (currentData.formFieldAnnotationType === 'SignatureField' || currentData.formFieldAnnotationType === 'InitialField') {
                        if (currentData.signatureType === 'Text' && !this_3.pdfViewerBase.signatureModule.checkDefaultFont(currentData.fontFamily)) {
                            this_3.getTextToImage(currentData);
                        }
                    }
                }
            };
