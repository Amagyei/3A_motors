    ...
    AnnotationRenderer.prototype.addTextMarkup = function (details, loadedDocument) {
        ...
        var _loop_1 = function (i) {
            ...
            if (!isNullOrUndefined(bound['left'])) {
                boundsCollection.push(new Rect(cropValues.x + this_1.convertPixelToPoint(bound['left']), cropValues.y + this_1.convertPixelToPoint(bound['top']), Object.prototype.hasOwnProperty.call(bound, 'width') ? this_1.convertPixelToPoint(bound['width']) : 0, Object.prototype.hasOwnProperty.call(bound, 'height') ? this_1.convertPixelToPoint(bound['height']) : 0));
            }
            ...
            for (var _i = 0, boundsCollection_1 = boundsCollection; _i < boundsCollection_1.length; _i++) {
                var rect = boundsCollection_1[_i];
