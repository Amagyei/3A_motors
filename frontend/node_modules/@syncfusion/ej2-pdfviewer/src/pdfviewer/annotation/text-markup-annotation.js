    ...
    TextMarkupAnnotation.prototype.rerenderAnnotationsPinch = function (pageNumber) {
        ...
        if (annotCanvas) {
            ...
            if (this.pdfViewer.restrictZoomRequest) {
                annotCanvas.style.width = this.pdfViewerBase.pageSize[parseInt(pageNumber.toString(), 10)].width * this.pdfViewerBase.getZoomFactor() + 'px';
                annotCanvas.style.height = this.pdfViewerBase.pageSize[parseInt(pageNumber.toString(), 10)].height * this.pdfViewerBase.getZoomFactor() + 'px';
            }
            else {
                annotCanvas.width =
