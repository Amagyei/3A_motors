...
var Renderer = /** @class */ (function () {
    ...
    Renderer.prototype.renderEditregionContentHighlight = function (page, lineWidget, top) {
        if (!isNullOrUndefined(this.documentHelper.owner.editorModule) && page.documentHelper.selection && !isNullOrUndefined(page.documentHelper.selection.contentControleditRegionHighlighters)) {
            var contenControl = page.documentHelper.selection.contentControl;
                            ...
                            if (lineIndex === 0 || lineWidget === contenControl.line) {
                                ...
                                if (!isNullOrUndefined(lastLine) && (!isNullOrUndefined(page.nextPage) || !isNullOrUndefined(paragraph.nextWidget)) && lineWidget === lastLine && lastLine.children[lastLine.children.length - 1] instanceof ContentControl && lastLine.children[lastLine.children.length - 1] === contenControl.reference && contenControl.contentControlWidgetType === 'Block') {
                                    ...
                                    if (widgetInfo.length > 1) {
                                        ...
                                        var endUpdated = this.documentHelper.getParagraphLeftPosition(paragraph) + this.getContainerWidth(paragraph, page) + HelperMethods.convertPointToPixel(paragraph.paragraphFormat.borders.right.space);
                                        this.renderSingleBorder(color, endX, startY, endUpdated, startY, 1, 'single');
                                        if (startX < widgets_1[j].left - 2 && contenControl.contentControlWidgetType !== 'Block') {
    ...
    Renderer.prototype.renderTextElementBox = function (elementBox, left, top, underlineY) {
        ...
        if (this.documentHelper.owner.isSpellCheck) {
            if (((this.documentHelper.owner.isSpellCheck && !this.spellChecker.removeUnderline) && (this.documentHelper.triggerSpellCheck || elementBox.canTrigger) && elementBox.text !== ' ' && !this.documentHelper.isScrollHandler && (isNullOrUndefined(elementBox.previousNode) || !(elementBox.previousNode instanceof FieldElementBox && elementBox.previousNode.fieldType === 2)))) {
                elementBox.canTrigger = true;
        ...
        if (!this.spellChecker.checkElementCanBeCombined(elementBox, underlineY, beforeIndex, true)) {
            ...
            if (splittedText.length > 1) {
                if (elementBox.previousElement instanceof FieldElementBox) {
                    for (var i = 0; i < elementBox.line.children.length; i++) {
    ...
    Renderer.prototype.renderImageElementBox = function (elementBox, left, top, underlineY) {
        ...
        if (elementBox.textWrappingStyle === 'Inline') {
            if (topMargin < 0 || elementBox.line.paragraph.width < elementBox.width) {
                ...
                var width_3 = containerWid.width + containerWid.margin.left - containerWid.leftBorderWidth;
                isClipped = true;
                this.clipRect(containerWid.x, containerWid.y, this.getScaledValue(width_3), this.getScaledValue(containerWid.height));
            }
        }
    ...
    Renderer.prototype.renderTableCellOutline = function (documentHelper, cellWidget) {
        ...
        var allowButtomBorderRender = !isNullOrUndefined(nextRow) && isLastCell && (!(nextRow.rowFormat.gridAfter > 0 || nextRow.rowFormat.gridBefore > 0)
    ...
    Renderer.prototype.renderCellBackground = function (height, cellWidget, leftMargin, rightMargin, lineWidth) {
        ...
        if (bgColor !== 'empty') {
            var cellLeftBorder = TableCellWidget.getCellLeftBorder(cellWidget);
            var cellTopBorder = TableCellWidget.getCellTopBorder(cellWidget);
