...
var DocumentHelper = /** @class */ (function () {
    ...
    function DocumentHelper(owner) {
        ...
        this.onMouseUpInternal = function (event) {
            ...
            if (_this.isMappedContentControlUpdated) {
                _this.mapContentControls();
            }
            event.preventDefault();
            ...
            if (!isNullOrUndefined(_this.selection)) {
                ...
                if (_this.isMouseDown && _this.isLeftButtonPressed(event) && _this.isDocumentProtected
                    ...
                    if (!formField && _this.isFormFillProtectedMode) {
                        var contentControl = _this.owner.editor.getContentControl();
                ...
                if (!isNullOrUndefined(_this.dragStartParaInfo) && !isNullOrUndefined(_this.dragEndParaInfo) && _this.dragEndParaInfo.paragraph.equals(_this.dragStartParaInfo.paragraph)
                    && _this.dragStartParaInfo.offset < _this.dragEndParaInfo.offset) {
                    var index = 0;
                    var currentInline = _this.dragStartParaInfo.paragraph.getInline(_this.dragEndParaInfo.offset, index);
    ...
    */
    ...
    DocumentHelper.prototype.mapContentControls = function () {
        if (this.contentControlCollection.length > 0) {
            for (var i = 0; i < this.contentControlCollection.length; i++) {
                for (var j = i + 1; j < this.contentControlCollection.length; j++) {
                    if (!isNullOrUndefined(this.contentControlCollection[i].contentControlProperties.xmlMapping) && !isNullOrUndefined(this.contentControlCollection[j].contentControlProperties.xmlMapping) &&
                        ...
                        var contentControlText1 = this.owner.editor.getResultContentControlText(this.contentControlCollection[i]);
                        var contentControlText2 = this.owner.editor.getResultContentControlText(this.contentControlCollection[j]);
