...
.e-chat-ui .e-chat-header .e-toolbar .e-toolbar-item .e-tbar-btn {
  border: none;
}
...
.e-chat-ui .e-message-group.e-left .e-text:not(:focus), .e-chat-ui .e-message-group.e-left .e-text:not(:active), .e-chat-ui .e-message-group.e-left .e-text:not(:hover) {
  border: 1px solid rgb(150, 150, 150);
}
.e-chat-ui .e-chat-header .e-toolbar-item.e-overlay {
  background: unset;
}
.e-chat-ui .e-chat-header .e-toolbar-item .e-tbar-btn:focus, .e-chat-ui .e-chat-header .e-toolbar-item .e-tbar-btn:active, .e-chat-ui .e-chat-header .e-toolbar-item .e-tbar-btn:hover {
  background: rgb(104, 87, 8);
}
.e-chat-ui .e-chat-header .e-toolbar-item .e-tbar-btn .e-tbar-btn-text:focus, .e-chat-ui .e-chat-header .e-toolbar-item .e-tbar-btn .e-tbar-btn-text:active, .e-chat-ui .e-chat-header .e-toolbar-item .e-tbar-btn .e-tbar-btn-text:hover,
.e-chat-ui .e-chat-header .e-toolbar-item .e-tbar-btn .e-btn-icon:focus,
.e-chat-ui .e-chat-header .e-toolbar-item .e-tbar-btn .e-btn-icon:active,
.e-chat-ui .e-chat-header .e-toolbar-item .e-tbar-btn .e-btn-icon:hover {
