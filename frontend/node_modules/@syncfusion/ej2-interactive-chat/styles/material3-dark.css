...
.e-aiassistview .e-views .e-content-body blockquote {
  border-left: 4px solid linear-gradient(0deg, rgba(var(--color-sf-primary), 0.08), rgba(var(--color-sf-primary), 0.08)), rgba(var(--color-sf-surface));
}
.e-aiassistview .e-views .e-content-body img,
.e-aiassistview .e-views .e-content-body svg {
...
.e-aiassistview .e-footer .e-input-group.e-multi-line-input {
  border: 1px solid rgba(var(--color-sf-outline-variant)) !important; /* stylelint-disable-line declaration-no-important */
}
.e-aiassistview .e-footer:not(.e-footer-template) .e-assist-send {
...
.e-aiassistview.e-rtl .e-views .e-content-body blockquote {
  border-right: 4px solid linear-gradient(0deg, rgba(var(--color-sf-primary), 0.08), rgba(var(--color-sf-primary), 0.08)), rgba(var(--color-sf-surface));
}
...
.e-bigger.e-aiassistview .e-assist-send,
.e-bigger .e-aiassistview .e-assist-send {
  font-size: 20px;
  bottom: 11px;
}
...
.e-chat-ui .e-chat-header .e-toolbar-item .e-tbar-btn:hover {
  background: rgba(0, 0, 0, 0.056);
}
.e-chat-ui .e-chat-header .e-toolbar-item .e-tbar-btn:focus {
  -webkit-box-shadow: 0 0 0 1px rgb(255, 255, 255);
          box-shadow: 0 0 0 1px rgb(255, 255, 255);
  -webkit-box-shadow: 0 0 0 1px rgb(0, 0, 0);
          box-shadow: 0 0 0 1px rgb(0, 0, 0);
}
.e-chat-ui .e-chat-header .e-toolbar-item .e-tbar-btn .e-tbar-btn-text:not(:active),
.e-chat-ui .e-chat-header .e-toolbar-item .e-tbar-btn .e-btn-icon:not(:active) {
  color: rgb(255, 255, 255);
  color: rgb(0, 0, 0);
}
.e-chat-ui .e-chat-header .e-toolbar-item .e-dropdown-btn,
.e-chat-ui .e-chat-header .e-toolbar-item .e-dropdown-btn.e-btn {
  -webkit-box-shadow: none;
          box-shadow: none;
}
.e-chat-ui .e-chat-header .e-toolbar-item .e-dropdown-btn:focus, .e-chat-ui .e-chat-header .e-toolbar-item .e-dropdown-btn:active, .e-chat-ui .e-chat-header .e-toolbar-item .e-dropdown-btn:hover,
.e-chat-ui .e-chat-header .e-toolbar-item .e-dropdown-btn.e-btn:focus,
.e-chat-ui .e-chat-header .e-toolbar-item .e-dropdown-btn.e-btn:active,
.e-chat-ui .e-chat-header .e-toolbar-item .e-dropdown-btn.e-btn:hover {
  -webkit-box-shadow: none;
          box-shadow: none;
}
