...
.e-aiassistview .e-assist-send.disabled {
  pointer-events: none;
  opacity: 0.5;
  cursor: not-allowed;
}
.e-aiassistview .e-assist-send.enabled {
  pointer-events: auto;
  opacity: 1;
  cursor: pointer;
}
...
.e-aiassistview .e-footer:has(.e-rtl) .e-assist-send {
  right: unset;
  left: 20px;
}
...
.e-aiassistview .e-footer .e-assist-send:not(.disabled):focus-visible,
...
.e-chat-ui .e-chat-send.disabled {
  pointer-events: none;
  opacity: 0.5;
  cursor: not-allowed;
}
.e-chat-ui .e-chat-send.enabled {
  pointer-events: auto;
  opacity: 1;
  cursor: pointer;
}
...
.e-chat-ui .e-footer:has(.e-rtl) .e-chat-send {
  right: unset;
  left: 20px;
}
...
.e-chat-ui .e-footer .e-chat-send:not(.disabled):focus-visible {
  outline: 1px solid;
}
.e-chat-ui .e-chat-content,
.e-chat-ui .e-message-wrapper {
